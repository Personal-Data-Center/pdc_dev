...
MIDDLEWARE = [
    ...
    'pdc.service.apiKeyManagement.middleware.keyCheck',
]

ROOT_URLCONF = 'pdc.service.base.urls'
...
WSGI_APPLICATION = 'pdc.service.base.wsgi.application'
